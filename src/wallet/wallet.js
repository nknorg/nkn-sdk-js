...
export default class Wallet {
  ...
  static version = 1;
  static minCompatibleVersion = 1;
  static maxCompatibleVersion = 1;
  ...
  static fromJSON(walletJson, password) {
    ...
    walletJson = Object.keys(walletJson).reduce((merged, key) => Object.assign(merged, {[key.toLowerCase()]: walletJson[key]}), {});
