...
var nameRegistrationFee = exports.nameRegistrationFee = "10";
function newTransferPayload(sender, recipient, amount) {
  var transfer = new common.pb.transaction.TransferAsset();
  ...
  var pld = new common.pb.transaction.Payload();
  pld.setType(common.pb.transaction.PayloadType.TRANSFER_ASSET_TYPE);
  pld.setData(transfer.serializeBinary());
  return pld;
}
function newRegisterNamePayload(registrant, name) {
  var registrationFee = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : nameRegistrationFee;
  var registerName = new common.pb.transaction.RegisterName();
...
function newTransferNamePayload(name, registrant, recipient) {
  var transferName = new common.pb.transaction.TransferName();
...
function newDeleteNamePayload(registrant, name) {
  var deleteName = new common.pb.transaction.DeleteName();
...
function newSubscribePayload(subscriber, identifier, topic, duration, meta) {
  var subscribe = new common.pb.transaction.Subscribe();
...
function newUnsubscribePayload(subscriber, identifier, topic) {
  var unsubscribe = new common.pb.transaction.Unsubscribe();
...
function newNanoPayPayload(sender, recipient, id, amount, txnExpiration, nanoPayExpiration) {
  var nanoPay = new common.pb.transaction.NanoPay();
...
function newTransaction(_x, _x2, _x3) {
  return _newTransaction.apply(this, arguments);
}
function _newTransaction() {
  _newTransaction = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(account, pld, nonce) {
    var fee,
      attrs,
      unsignedTx,
      txn,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          fee = _args.length > 3 && _args[3] !== undefined ? _args[3] : "0";
          attrs = _args.length > 4 && _args[4] !== undefined ? _args[4] : "";
          unsignedTx = new common.pb.transaction.UnsignedTx();
          ...
          txn = new common.pb.transaction.Transaction();
          txn.setUnsignedTx(unsignedTx);
          _context.next = 11;
          return signTx(account, txn);
        case 11:
...
function signTx(_x4, _x5) {
  return _signTx.apply(this, arguments);
}
function _signTx() {
  _signTx = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(account, txn) {
    var unsignedTx, hex, digest, signature, prgm;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          unsignedTx = txn.getUnsignedTx();
          hex = serializeUnsignedTx(unsignedTx);
          digest = common.hash.sha256Hex(hex);
          _context2.next = 5;
          return account.key.sign(digest);
        case 5:
          signature = _context2.sent;
          txn.hash = common.hash.doubleSha256Hex(hex);
          prgm = new common.pb.transaction.Program();
